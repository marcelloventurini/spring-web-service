...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Order o1 = new Order(null, Instant.parse("2022-06-20T19:22:07Z"), u1);
    Order o2 = new Order(null, Instant.parse("2022-07-21T03:33:07Z"), u2);
    Order o3 = new Order(null, Instant.parse("2022-07-22T15:53:07Z"), u1);
